...
class _AdminApiService implements AdminApiService {
  ...
  @override
  Future<HttpResponse<SignupResponse>> signup(Map<String, String> body) async {
  ...
  @override
  Future<HttpResponse<void>> verifyToken(Map<String, dynamic> token) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<dynamic>> checkUsernameValidity(
